...
public class CompatCubes {
    ...
    public void addTo(ModelPart part) {
        for (Cube cube : cubes) {
            part.setTextureOffset(cube.u, cube.v);
            part.mirror = cube.mirror;
            part.addCuboid(cube.x, cube.y, cube.z, cube.width, cube.height, cube.depth, cube.inflate);
        }
        part.mirror = false;
    }
