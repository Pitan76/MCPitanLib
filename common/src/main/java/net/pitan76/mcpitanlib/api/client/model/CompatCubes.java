...
public class CompatCubes {
    ...
    public CubeListBuilder toRaw() {
        CubeListBuilder builder = CubeListBuilder.create();
        for (Cube cube : cubes) {
            builder.texOffs(cube.u, cube.v).mirror(cube.mirror)
                    .addBox(cube.x, cube.y, cube.z, cube.width, cube.height, cube.depth, new CubeDeformation(cube.inflate));
        }
        return builder;
    }
