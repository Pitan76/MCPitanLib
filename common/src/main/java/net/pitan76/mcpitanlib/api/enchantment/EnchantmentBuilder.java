 ...
 * エンチャントを追加する。
 * <p>
 * このバージョンではエンチャントは静的レジストリにあるため、そのまま登録される。
...
public class EnchantmentBuilder {
    ...
    private EnchantmentEffectHandler postAttackHandler;
    private EnchantmentEffectHandler tickHandler;
    private EnchantmentEffectHandler hitBlockHandler;
    ...
    public EnchantmentBuilder onPostAttack(String enchanted, String affected, EnchantmentEffectHandler handler) {
        this.postAttackHandler = handler;
    ...
    /**
     * 攻撃時のハンドラ。このバージョンでは {@code ExtendEnchantment} が直接呼ぶ。
     */
    public EnchantmentEffectHandler getPostAttackHandler() {
        return postAttackHandler;
    }

    public EnchantmentEffectHandler getTickHandler() {
        return tickHandler;
    }

    public EnchantmentEffectHandler getHitBlockHandler() {
    ...
    public String toJson() {
        ...
        List<String> usedSlots = slots.isEmpty() ? java.util.Collections.singletonList("mainhand") : slots;
