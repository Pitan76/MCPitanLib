...
public class StatusEffectBuilder {
     ...
     */
    public RegistryResult<net.minecraft.entity.effect.StatusEffect> rawBuild(CompatRegistryV2 registry) {
        return registry.registerStatusEffect(id, this::create);
    }

    public RegistryResult<net.minecraft.entity.effect.StatusEffect> rawBuild(CommonModInitializer initializer) {
