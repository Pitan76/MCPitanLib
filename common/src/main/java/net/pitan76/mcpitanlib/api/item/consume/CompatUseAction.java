...
public class CompatUseAction implements CompatStringIdentifiable {
    ...
    public static final CompatUseAction SPYGLASS = of(UseAction.NONE);
    public static final CompatUseAction TOOT_HORN = of(UseAction.NONE);
    public static final CompatUseAction BRUSH = of(UseAction.NONE);
