...
public class CompatibleShovelItem extends ShovelItem implements ExtendItemProvider, CompatItemProvider {
    public net.pitan76.mcpitanlib.api.item.v2.CompatibleItemSettings settings;

    public CompatibleShovelItem(CompatibleToolMaterial material, float attackDamage, float attackSpeed, net.pitan76.mcpitanlib.api.item.v2.CompatibleItemSettings settings) {
        super(material.build(), attackDamage, attackSpeed, settings.build());
        this.settings = settings;
    }

    public CompatibleShovelItem(float attackDamage, float attackSpeed, ToolMaterial material, net.pitan76.mcpitanlib.api.item.v2.CompatibleItemSettings settings) {
