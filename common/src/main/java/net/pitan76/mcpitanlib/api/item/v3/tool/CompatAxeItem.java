...
public class CompatAxeItem extends CompatibleAxeItem {

    public CompatAxeItem(CompatibleToolMaterial material, float attackDamage, float attackSpeed, CompatibleItemSettings settings) {
        super(material, attackDamage, attackSpeed, settings);
    }

    public CompatAxeItem(CompatibleToolMaterial material, float attackDamage, float attackSpeed, ItemSettingsBuilder builder, CompatIdentifier id) {
        this(material, attackDamage, attackSpeed, builder.build(id));
    }

    public CompatAxeItem(CompatibleToolMaterial material, float attackDamage, float attackSpeed, ItemSettingsBuilder builder) {
