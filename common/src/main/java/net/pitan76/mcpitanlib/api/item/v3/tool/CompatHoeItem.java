...
public class CompatHoeItem extends CompatibleHoeItem {

    public CompatHoeItem(CompatibleToolMaterial material, int attackDamage, float attackSpeed, CompatibleItemSettings settings) {
        super(material, attackDamage, attackSpeed, settings);
    }

    public CompatHoeItem(CompatibleToolMaterial material, int attackDamage, float attackSpeed, ItemSettingsBuilder builder, CompatIdentifier id) {
        this(material, attackDamage, attackSpeed, builder.build(id));
    }

    public CompatHoeItem(CompatibleToolMaterial material, int attackDamage, float attackSpeed, ItemSettingsBuilder builder) {
