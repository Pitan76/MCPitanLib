...
import net.pitan76.mcpitanlib.api.enchantment.ExtendEnchantment;
...
public class CompatRegistryV2 {
    ...
    /**
     * このバージョンではエンチャントが静的レジストリにあるため、そのまま登録する。
     */
    public EnchantmentWrapper registerEnchantment(EnchantmentBuilder builder) {
        cr1.registerEnchantment(builder.id.toMinecraft(), () -> new ExtendEnchantment(builder));
