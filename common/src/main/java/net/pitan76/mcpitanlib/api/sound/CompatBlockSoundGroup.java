...
public class CompatBlockSoundGroup {
    ...
    public static final CompatBlockSoundGroup POWDER_SNOW = of(BlockSoundGroup.SNOW);
    ...
    public static final CompatBlockSoundGroup CANDLE = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup AMETHYST_BLOCK = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup AMETHYST_CLUSTER = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup SMALL_AMETHYST_BUD = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup MEDIUM_AMETHYST_BUD = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup LARGE_AMETHYST_BUD = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup TUFF = of(BlockSoundGroup.STONE);
    ...
    public static final CompatBlockSoundGroup CALCITE = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup DRIPSTONE_BLOCK = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup POINTED_DRIPSTONE = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup COPPER = of(BlockSoundGroup.METAL);
    ...
    public static final CompatBlockSoundGroup CAVE_VINES = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup SPORE_BLOSSOM = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup AZALEA = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup FLOWERING_AZALEA = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup MOSS_CARPET = of(BlockSoundGroup.WOOD);
    public static final CompatBlockSoundGroup PINK_PETALS = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup MOSS_BLOCK = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup BIG_DRIPLEAF = of(BlockSoundGroup.GRASS);
    public static final CompatBlockSoundGroup SMALL_DRIPLEAF = of(BlockSoundGroup.GRASS);
    public static final CompatBlockSoundGroup ROOTED_DIRT = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup HANGING_ROOTS = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup AZALEA_LEAVES = of(BlockSoundGroup.GRASS);
    public static final CompatBlockSoundGroup SCULK_SENSOR = of(BlockSoundGroup.STONE);
    ...
    public static final CompatBlockSoundGroup GLOW_LICHEN = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup DEEPSLATE = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup DEEPSLATE_BRICKS = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup DEEPSLATE_TILES = of(BlockSoundGroup.STONE);
    public static final CompatBlockSoundGroup POLISHED_DEEPSLATE = of(BlockSoundGroup.STONE);
