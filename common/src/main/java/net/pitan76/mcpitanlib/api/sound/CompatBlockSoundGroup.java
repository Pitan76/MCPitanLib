...
public class CompatBlockSoundGroup {
    ...
    public static final CompatBlockSoundGroup SCULK_CATALYST = of(BlockSoundGroup.SCULK_CATALYST);
    public static final CompatBlockSoundGroup SCULK = of(BlockSoundGroup.SCULK);
    public static final CompatBlockSoundGroup SCULK_VEIN = of(BlockSoundGroup.SCULK_VEIN);
    public static final CompatBlockSoundGroup SCULK_SHRIEKER = of(BlockSoundGroup.SCULK_SHRIEKER);
    ...
    public static final CompatBlockSoundGroup FROGLIGHT = of(BlockSoundGroup.FROGLIGHT);
    public static final CompatBlockSoundGroup FROGSPAWN = of(BlockSoundGroup.FROGSPAWN);
    public static final CompatBlockSoundGroup MANGROVE_ROOTS = of(BlockSoundGroup.MANGROVE_ROOTS);
    public static final CompatBlockSoundGroup MUDDY_MANGROVE_ROOTS = of(BlockSoundGroup.MUDDY_MANGROVE_ROOTS);
    public static final CompatBlockSoundGroup MUD = of(BlockSoundGroup.MUD);
    public static final CompatBlockSoundGroup MUD_BRICKS = of(BlockSoundGroup.MUD_BRICKS);
    public static final CompatBlockSoundGroup PACKED_MUD = of(BlockSoundGroup.PACKED_MUD);
    public static final CompatBlockSoundGroup HANGING_SIGN = of(BlockSoundGroup.HANGING_SIGN);
    public static final CompatBlockSoundGroup NETHER_WOOD_HANGING_SIGN = of(BlockSoundGroup.NETHER_WOOD_HANGING_SIGN);
    public static final CompatBlockSoundGroup BAMBOO_WOOD_HANGING_SIGN = of(BlockSoundGroup.BAMBOO_WOOD_HANGING_SIGN);
    public static final CompatBlockSoundGroup BAMBOO_WOOD = of(BlockSoundGroup.BAMBOO_WOOD);
    public static final CompatBlockSoundGroup NETHER_WOOD = of(BlockSoundGroup.NETHER_WOOD);
    public static final CompatBlockSoundGroup CHERRY_WOOD = of(BlockSoundGroup.CHERRY_WOOD);
    public static final CompatBlockSoundGroup CHERRY_SAPLING = of(BlockSoundGroup.CHERRY_SAPLING);
    public static final CompatBlockSoundGroup CHERRY_LEAVES = of(BlockSoundGroup.CHERRY_LEAVES);
    public static final CompatBlockSoundGroup CHERRY_WOOD_HANGING_SIGN = of(BlockSoundGroup.CHERRY_WOOD_HANGING_SIGN);
    public static final CompatBlockSoundGroup CHISELED_BOOKSHELF = of(BlockSoundGroup.CHISELED_BOOKSHELF);
    ...
    public static final CompatBlockSoundGroup VAULT = of(BlockSoundGroup.VAULT);
    public static final CompatBlockSoundGroup HEAVY_CORE = of(BlockSoundGroup.HEAVY_CORE);
    public static final CompatBlockSoundGroup COBWEB = of(BlockSoundGroup.COBWEB);
