...
public class ComparatorModeProperty extends EnumProperty<ComparatorMode> {
    ...
    public ComparatorModeProperty(net.minecraft.state.property.EnumProperty<ComparatorMode> property) {
        super(property);
    }

    public static ComparatorModeProperty ofRaw(net.minecraft.state.property.EnumProperty<ComparatorMode> property) {
