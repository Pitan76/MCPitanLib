...
public class EnergyLookup {
     ...
     */
    public void registerForBlockEntity(BiFunction<BlockEntity, net.minecraft.util.math.Direction, IEnergyStorage> provider, RegistryResult<BlockEntityType<?>> type) {
