...
public class BlockStateUtil {
    ...
    public static ActionResult onUse(BlockState state, World world, Player player, BlockHitResult hitResult) {
        return state.onUse(world, player.getEntity(), hitResult);
    }
    ...
    public static ItemActionResult onUseWithItem(BlockState state, ItemStack stack, World world, PlayerEntity player, Hand hand, BlockHitResult hit) {
        return state.onUseWithItem(stack, world, player, hand, hit);
    }
    ...
    public static ActionResult onUseWithItem_actionResult(BlockState state, ItemStack stack, World world, PlayerEntity player, Hand hand, BlockHitResult hit) {
        return onUseWithItem(state, stack, world, player, hand, hit).toActionResult();
    }
}
