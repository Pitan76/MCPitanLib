...
public class RecipeUtil {
    ...
    public static ItemStack getOutput(Recipe<?> recipe, CompatRegistryLookup registryLookup) {
        if (registryLookup.getRegistryLookup() instanceof DynamicRegistryManager) {
            return recipe.getOutput((DynamicRegistryManager) registryLookup.getRegistryLookup());
        }
    ...
    public static ItemStack getOutput(CompatRecipeEntry<?> recipeEntry, CompatRegistryLookup registryLookup) {
        if (registryLookup.getRegistryLookup() instanceof DynamicRegistryManager) {
            return recipeEntry.getRecipe().getOutput((DynamicRegistryManager) registryLookup.getRegistryLookup());
        }
