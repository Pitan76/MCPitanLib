...
public class CompatMapColor {
    ...
    public static final CompatMapColor DULL_RED = of(MapColor.RED);
    public static final CompatMapColor DULL_PINK = of(MapColor.PINK);
    public static final CompatMapColor DARK_CRIMSON = of(MapColor.DARK_RED);
    public static final CompatMapColor TEAL = of(MapColor.RED);
    public static final CompatMapColor DARK_AQUA = of(MapColor.WATER_BLUE);
    public static final CompatMapColor DARK_DULL_PINK = of(MapColor.TERRACOTTA_PINK);
    public static final CompatMapColor BRIGHT_TEAL = of(MapColor.BRIGHT_RED);
    public static final CompatMapColor DEEPSLATE_GRAY = of(MapColor.STONE_GRAY);
    public static final CompatMapColor RAW_IRON_PINK = of(MapColor.PINK);
    public static final CompatMapColor LICHEN_GREEN = of(MapColor.GREEN);
