...
public class CompatBlockRotation implements CompatStringIdentifiable {
    ...
    public CompatBlockRotation(Rotation rotation) {
        this.rotation = rotation;
    }

    public static CompatBlockRotation of(Rotation rotation) {
    ...
    public Rotation getRaw() {
        return rotation;
    }

    public Rotation toMinecraft() {
        return rotation;
    }
    ...
    public static List<CompatBlockRotation> shuffled(CompatRandom random) {
        ...
        for (Rotation rotation : Rotation.getShuffled(random.getMcRandom())) {
