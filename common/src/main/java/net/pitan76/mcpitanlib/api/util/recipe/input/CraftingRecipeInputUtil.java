...
public class CraftingRecipeInputUtil {
    ...
    public static CompatRecipeInput<?> create(int width, int height, List<ItemStack> stacks) {
        return new CompatRecipeInput<>(CraftingInput.of(width, height, stacks));
    }

    public static ItemStack getStack(CraftingInput input, int x, int y) {
        return input.getItem(x, y);
    }

    public static ItemStack getStack(CompatRecipeInput<?> input, int x, int y) {
        Optional<CraftingInput> recipeInput = get(input);
    ...
    public static StackedItemContents getRecipeMatcher(CraftingInput input) {
        return input.stackedContents();
    }

    public static StackedItemContents getRecipeMatcher(CompatRecipeInput<?> input) {
        Optional<CraftingInput> recipeInput = get(input);
    ...
    public static List<ItemStack> getStacks(CraftingInput input) {
        return input.items();
    }
