...
public class SlotRenderer {
    ...
    public static void drawSlots(DrawObjectDM drawObjectDM, AbstractContainerMenu handler, int x, int y) {
        ScreenHandlerUtil.getSlots(handler).forEach((slot) -> drawSlot(drawObjectDM, slot, x, y));
    }

    public static void drawPlayerMainInventorySlots(DrawObjectDM drawObjectDM, AbstractContainerMenu handler, int x, int y) {
        RendererUtil.drawTexture(drawObjectDM, GuiTextures.GUI_PARTS, x, y, 0, 32, 162, 54);
    }

    public static void drawPlayerHotbarSlots(DrawObjectDM drawObjectDM, AbstractContainerMenu handler, int x, int y) {
