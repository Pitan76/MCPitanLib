...
public class EnchantmentWrapper {
     ...
     */
    public Optional<RegistryEntry.Reference<Enchantment>> getEntry(World world) {
        return world.getRegistryManager().getOptionalWrapper(RegistryKeys.ENCHANTMENT).flatMap(wrapper -> wrapper.getOptional(key));
    }
    ...
    public Optional<Enchantment> get(World world) {
        return getEntry(world).map(RegistryEntry.Reference::value);
    }
