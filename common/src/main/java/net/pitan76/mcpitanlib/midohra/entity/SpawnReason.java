...
public class SpawnReason {
    ...
    public static final SpawnReason SPAWN_ITEM_USE = of(net.minecraft.entity.SpawnReason.NATURAL);
    ...
    public static final SpawnReason TRIAL_SPAWNER = of(net.minecraft.entity.SpawnReason.NATURAL);
