...
public class ArrowEntityWrapper extends PersistentProjectileEntityWrapper<Arrow> {
    protected ArrowEntityWrapper(Arrow entity) {
        super(entity);
    }

    public static ArrowEntityWrapper ofRaw(Arrow entity) {
        return new ArrowEntityWrapper(entity);
    }

    public static ArrowEntityWrapper ofArrow(EntityWrapper wrapper) {
        return new ArrowEntityWrapper((Arrow) wrapper.get());
    }

    public static boolean isArrow(EntityWrapper wrapper) {
        return wrapper.get() instanceof Arrow;
    }
