...
public class SmallFireballEntityWrapper extends ProjectileEntityWrapper<SmallFireballEntity> {
    protected SmallFireballEntityWrapper(SmallFireballEntity entity) {
        super(entity);
    }

    public static SmallFireballEntityWrapper ofRaw(SmallFireballEntity entity) {
    ...
    public static SmallFireballEntityWrapper ofSmallFireball(EntityWrapper wrapper) {
        return new SmallFireballEntityWrapper((SmallFireballEntity) wrapper.get());
    }

    public static boolean isSmallFireball(EntityWrapper wrapper) {
        return wrapper.get() instanceof SmallFireballEntity;
    }
