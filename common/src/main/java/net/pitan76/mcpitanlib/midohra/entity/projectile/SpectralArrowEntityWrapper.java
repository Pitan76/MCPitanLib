...
public class SpectralArrowEntityWrapper extends PersistentProjectileEntityWrapper<SpectralArrow> {
    protected SpectralArrowEntityWrapper(SpectralArrow entity) {
        super(entity);
    }

    public static SpectralArrowEntityWrapper ofRaw(SpectralArrow entity) {
    ...
    public static SpectralArrowEntityWrapper ofSpectralArrow(EntityWrapper wrapper) {
        return new SpectralArrowEntityWrapper((SpectralArrow) wrapper.get());
    }

    public static boolean isSpectralArrow(EntityWrapper wrapper) {
        return wrapper.get() instanceof SpectralArrow;
    }
