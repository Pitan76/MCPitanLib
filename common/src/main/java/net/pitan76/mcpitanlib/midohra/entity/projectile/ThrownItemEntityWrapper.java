...
public class ThrownItemEntityWrapper<T extends ThrownItemEntity> extends ThrownEntityWrapper<T> {
    protected ThrownItemEntityWrapper(T entity) {
        super(entity);
    }

    public static <T extends ThrownItemEntity> ThrownItemEntityWrapper<T> ofRaw(T entity) {
        return new ThrownItemEntityWrapper<>(entity);
    }

    public static <T extends ThrownItemEntity> ThrownItemEntityWrapper<T> ofThrownItem(EntityWrapper wrapper) {
        return new ThrownItemEntityWrapper<>((T) wrapper.get());
    }

    public static boolean isThrownItem(EntityWrapper wrapper) {
        return wrapper.get() instanceof ThrownItemEntity;
    }
