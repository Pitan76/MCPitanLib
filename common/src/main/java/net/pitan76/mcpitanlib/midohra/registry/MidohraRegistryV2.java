...
public class MidohraRegistryV2 {
    ...
    public <T extends AbstractContainerMenu> SupplierTypedScreenHandlerTypeWrapper<T> registerRawScreenHandlerType(CompatIdentifier id, Supplier<MenuType<T>> supplier) {
        Supplier<MenuType<T>> result = getCompatRegistry().registerScreenHandlerTypeSavingGenerics(id, supplier);
        return SupplierTypedScreenHandlerTypeWrapper.of(result);
    }

    public <T extends AbstractContainerMenu> SupplierTypedScreenHandlerTypeWrapper<T> registerScreenHandlerType(CompatIdentifier id, SimpleScreenHandlerTypeBuilder<T> builder) {
        return registerRawScreenHandlerType(id, builder::build);
    }

    public <T extends AbstractContainerMenu> SupplierTypedScreenHandlerTypeWrapper<T> registerScreenHandlerType(CompatIdentifier id, ExtendedScreenHandlerTypeBuilder<T> builder) {
        return registerRawScreenHandlerType(id, builder::build);
    }

    public <T extends AbstractContainerMenu> SupplierTypedScreenHandlerTypeWrapper<T> registerScreenHandlerType(String id, SimpleScreenHandlerTypeBuilder<T> builder) {
        return registerScreenHandlerType(fixId(id), builder);
    }

    public <T extends AbstractContainerMenu> SupplierTypedScreenHandlerTypeWrapper<T> registerScreenHandlerType(String id, ExtendedScreenHandlerTypeBuilder<T> builder) {
        return registerScreenHandlerType(fixId(id), builder);
    }
