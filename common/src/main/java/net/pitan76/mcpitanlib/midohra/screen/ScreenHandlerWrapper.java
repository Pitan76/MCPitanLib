...
public class ScreenHandlerWrapper {
    private final net.minecraft.screen.ScreenHandler screenHandler;
    ...
    protected ScreenHandlerWrapper(net.minecraft.screen.ScreenHandler screenHandler) {
        this.screenHandler = screenHandler;
    }

    public static ScreenHandlerWrapper of(net.minecraft.screen.ScreenHandler screenHandler) {
    ...
    public net.minecraft.screen.ScreenHandler get() {
        return screenHandler;
    }

    public ItemStackList getStacks() {
        return ItemStackList.of(get().getStacks());
    }
