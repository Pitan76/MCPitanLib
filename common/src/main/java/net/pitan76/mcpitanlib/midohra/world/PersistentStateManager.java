...
public class PersistentStateManager {
    private final net.minecraft.world.level.storage.SavedDataStorage raw;

    public PersistentStateManager(net.minecraft.world.level.storage.SavedDataStorage storage) {
        this.raw = storage;
    }

    public static PersistentStateManager of(net.minecraft.world.level.storage.SavedDataStorage storage) {
        return new PersistentStateManager(storage);
    }

    public SavedDataStorage getRaw() {
        return raw;
    }
