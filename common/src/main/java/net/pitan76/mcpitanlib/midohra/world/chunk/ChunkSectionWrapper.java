...
public class ChunkSectionWrapper {
    ...
    protected ChunkSectionWrapper(ChunkSection section, int bottomY) {
        this.section = section;
        this.bottomY = bottomY;
    }

    public static ChunkSectionWrapper of(ChunkSection section, int bottomY) {
        return new ChunkSectionWrapper(section, bottomY);
    }

    public ChunkSection getRaw() {
        return section;
    }

    public ChunkSection toMinecraft() {
        return getRaw();
    }
