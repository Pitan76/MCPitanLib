    ...
    public void init() {
        ...
        EXAMPLE_EFFECT = StatusEffectBuilder.of(_id("example_effect"))
                ...
                .onInstantApplied(e -> {
                    ...
                    double y = e.getServerWorld().getHeight(net.minecraft.world.level.levelgen.Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z);
                    e.getTarget().teleportTo(x, y, z);
                })
                .build(registry);
