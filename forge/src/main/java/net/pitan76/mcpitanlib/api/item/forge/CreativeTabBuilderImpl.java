...
public class CreativeTabBuilderImpl {
    ...
    public static ItemGroup build(Identifier identifier, Text displayName, final Supplier<ItemStack> iconSupplier, boolean noRenderedName, boolean noScrollbar, boolean special, String texture) {
