...
/**
 * MCPitanLibのIEnergyStorageをForgeのIEnergyStorageとして公開するためのラッパー。
 * <p>
 * {@link ForgeEnergyStorage} でない独自実装を登録した場合のフォールバック。
 */
public class ForgeWrappedEnergyStorage implements net.minecraftforge.energy.IEnergyStorage {

    public final IEnergyStorage storage;

    public ForgeWrappedEnergyStorage(IEnergyStorage storage) {
