...
public class CompatArmorModelRegistryImpl {
    ...
    private static class CustomModelArmorExtensions implements IClientItemExtensions {
        ...
        private static EquipmentSlot getSlot(ItemStack stack, EquipmentClientInfo.LayerType layerType) {
            Equippable equippable = stack.get(DataComponents.EQUIPPABLE);
            if (equippable != null) return equippable.slot();
            return layerType == EquipmentClientInfo.LayerType.HUMANOID_LEGGINGS ? EquipmentSlot.LEGS : EquipmentSlot.CHEST;
        }
        ...
        public Model getGenericArmorModel(ItemStack stack, EquipmentClientInfo.LayerType layerType, Model original) {
            ...
            HumanoidModel<?> model = models.computeIfAbsent(slot, s -> new HumanoidModel<>(humanoidModel.bake()));
        ...
        @Override
        public Identifier getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType layerType, EquipmentClientInfo.Layer layer, Identifier _default) {
            return texture;
        }
    }
}
